...
%%reflector reflect the signal 
%% driven element creates the RF wave and receives
%% directors direct the RF wave and increases the gain, more director higher gain lower field of view. 
%% matching stub is used to balance the folded dipole to 50 ohm. 
%% for this thesis this antenna will be used as a reference to the home-build helical antenna, most yagi antennas can be bought quite cheaply. 
