...
\subsection{Beam-width} %add it to radiation pattern
\subsection{Anechoic chamber} % describe what it is in the pathloss chanel only, and remove it form here
